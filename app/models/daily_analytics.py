...
class DailyAnalytics(Base):
    ...
    estimated_sold = Column(Numeric(10, 2), default=0)
    actual_sold = Column(Numeric(10, 2), default=0)
    remaining_stock = Column(Numeric(10, 2), default=0)

    revenue = Column(Numeric(12, 2), default=0)
    cost = Column(Numeric(12, 2), default=0)
    gross_profit = Column(Numeric(12, 2), default=0)

    damage_loss = Column(Numeric(12, 2), default=0)
